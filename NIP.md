...
| NIP-78 | App-specific data | 30078 | ✅ submissions / stakes / term signals (read + write) · legacy cache (read-only, see below) · `savedd:affiliate-rules` — owner-signed affiliate domain→code config (read all, write owner) |
