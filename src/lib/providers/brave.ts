 ...
 *      proxy (the proxy sees query + key). Existing Dsearch path.
 ...
 *
 * The engine path is how SAVEDD (and future community engines) can offer
 * Brave without exposing a shared key.
 */
