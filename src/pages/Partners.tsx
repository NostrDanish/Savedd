/**
 * Partners page — referral links + stats for the affiliate program.
 *
 ...
 * not settlement data. The 50/50 revenue share is reconciled from
 * affiliate-network reports off-platform (M-Aff2).
 */
...
const Partners = () => {
  ...
  useSeoMeta({
    title: `Partners - ${ENGINE_PROFILE.branding.name}`,
    description: 'Share SAVEDD, track your referrals, and earn a share of affiliate revenue.',
  });
        ...
        {!user ? (
          ...
          <div className="space-y-6">
            ...
            <p className="text-[11px] text-muted-foreground/60 leading-relaxed">
              ...
              settlement data. The 50% revenue share is settled from affiliate-network
              reports — commission attribution per partner is being added in the next
              milestone. Your referred users stay pseudonymous: you see counts, not
              identities.
            </p>
          </div>
        )}
